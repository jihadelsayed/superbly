...
class DeleteSavedMessage(View):
    def get(self, request, user_message):
        ...
        template_name = 'delete_saved_message.html'
    ...
    def post(self, request, user_message):
        ...
        try:
            ...
            messageObj = SavedMessages.objects.filter(user_id=userObj[0].id, message=message_only[0].strip())
